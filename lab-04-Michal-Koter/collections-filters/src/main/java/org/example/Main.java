...
import org.example.queries.calculator.GeneralCalculator;
import org.example.queries.calculator.abstraction.ICalculate;
import org.example.queries.filter.ByAgeFromFilter;
import org.example.queries.filter.ByAgeToFilter;
import org.example.queries.filter.ByNameFilter;
import org.example.queries.filter.GeneralFilter;
import org.example.queries.filter.abstraction.IFilterPeople;
import org.example.queries.page.PageCutter;
